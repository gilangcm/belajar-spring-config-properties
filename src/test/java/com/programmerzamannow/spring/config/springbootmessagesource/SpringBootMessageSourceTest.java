...
public class SpringBootMessageSourceTest {
    ...
    @Test
    void testHelloGils() {
        Assertions.assertEquals("Hello Gils", sampleSource.helloGils(Locale.ENGLISH));
        Assertions.assertEquals("Halo Gils", sampleSource.helloGils(new Locale("in_ID")));
    }
    ...
    public static class TestApplication {
        ...
        public static class SampleSource implements MessageSourceAware {
            ...
            public String helloGils(Locale locale){
                return messageSource.getMessage("hello", new Object[]{"Gils"}, locale);
            }
        }
    }
}
